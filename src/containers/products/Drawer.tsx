  ...
  return (
    <div className="modal-header d-flex align-items-center justify-content-between mb-1">
      ...
      <div className="todo-item-action d-flex align-items-center">
        <RippleButton color="info" tag={Link} to={`/admin/products/edit/${id}`}>
...
const Drawer: React.FC<Props> = (props) => {
  ...
  const { product } = Selector((state) => state.products)
  ...
  return (
    ...
    >
      <ModalHeader handleToggleDrawer={handleToggleDrawer} id={product!.id}>
        <span className="ml-2">
          {product ? product.productName.toUpperCase() : 'View'}
        </span>
      </ModalHeader>
